...
#ifdef __XT_SCOM_REMAP_H /////////////////// <- 如果在[application.h]定义此宏，则启动头文件重映射←┐   ##
#include "xt_scom_remap.h" ///////////////// <- 当启动重映射,则头文件包含将映射到本行定义的头文件←┘   ##
#else //##################################################################################################
...
#endif  //#ifdef __XT_SCOM_REMAP_H

#endif  //#ifndef XT_SCOM_H__
